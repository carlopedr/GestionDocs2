...
public class Pedido extends Documento{
    ...
    public Pedido(String id, LocalDate fecha) {
        super(id, fecha);
    }

    public Pedido(int numero, Organizacion proveedor, Persona vendedor, float valor, LocalDate fechaFac, float descuentos, float impuestos, String id, LocalDate fecha) {
        super(id, fecha);
        this.numero = numero;
