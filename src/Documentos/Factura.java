...
public class Factura extends Documento{
    ...
    public Factura(String id, LocalDate fecha) {
        super(id, fecha);
    }

    public Factura(int numero, Organizacion orgCliente, Persona cliente, float valor, LocalDate fechaFac, float descuentos, float impuestos, String id, LocalDate fecha) {
        super(id, fecha);
        this.numero = numero;
